...
class Akatusboleto_Akatusboleto_Model_Pagar extends Mage_Payment_Model_Method_Abstract
{
	protected $_formBlockType = 'akatusboleto/form_pay';
	protected $_infoBlockType = 'akatusboleto/info_pay';
    ...
    */
    ...
    public function assignData($data)
    {
		...
		$checkNomeCC = $data->getCheckFormapagamentoboleto();	
		...
		*/
    	...
    	->setCheckFormapagamentoboleto("boleto");
	...
	public function GeraXML(Varien_Object $payment, $amount){
		...
		<carrinho>			
			...
			$xml .= '<enderecos>
				<endereco>
					<tipo>entrega</tipo>
						<logradouro><![CDATA['.$logradouro.']]></logradouro>
						<numero>'.$numero.'</numero>
						<complemento><![CDATA['.$complemento.']]></complemento>
		...
		else
		{
			...
			if($data["resposta"]["status"]["value"]=="Em Análise"){
				...
				if($formapagamento=="boleto"){
	              ...
	              //$info = $this->getInfoInstance();
                  //$formapagamento=$info->getCheckFormapagamentoboleto();
