...
class Akatustef_Akatustef_Model_Pagar extends Mage_Payment_Model_Method_Abstract
{
	protected $_formBlockType = 'akatustef/form_pay';
	protected $_infoBlockType = 'akatustef/info_pay';
    ...
    */
    ...
    public function assignData($data)
    {
		...
		$checkNomeCC = $data->getCheckFormapagamentotef();	
